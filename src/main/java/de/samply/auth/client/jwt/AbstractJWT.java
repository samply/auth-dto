...
//            // TODO maybe delete? would prevent adding usesamplyauth in this class
//            if (useSamplyAuth) {
//                boolean tokenTypeValid = getTokenType().equals(claimsSet.getClaim(JWTVocabulary.TYPE));
//            }
//            signatureValid = signatureValid && tokenTypeValid;
//        }
    }
    ...
    public boolean isValid() {
        Date now = new Date();
        return signatureValid && now.before(getClaimsSet().getExpirationTime()) && now.after(getClaimsSet().getNotBeforeTime());
    }
